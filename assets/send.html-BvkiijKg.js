import{_ as n,o as s,c as a,d as e}from"./app-9KppsQwr.js";const t={},p=e(`<h1 id="拦截发送消息" tabindex="-1"><a class="header-anchor" href="#拦截发送消息"><span>拦截发送消息</span></a></h1><h2 id="使用方式" tabindex="-1"><a class="header-anchor" href="#使用方式"><span>使用方式</span></a></h2><blockquote><p>使用spring扫描实例, 实现<code>PipelineProcess</code>接口，指定泛型为<code>ProducerRecordModel</code>。</p></blockquote><div class="language-java line-numbers-mode" data-ext="java" data-title="java"><pre class="language-java"><code><span class="token annotation punctuation">@Slf4j</span>
